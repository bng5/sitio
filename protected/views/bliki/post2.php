...
define('DOKU_INC', Yii::app()->basePath.'/extensions/doku/');
...
//        $instruction_arr = (array) $instruction;
//foreach($instruction_arr as $ins) {

        echo "
            <li>{$instruction[0]}</li>";
//        if($instruction[0] == 'cdata' && end($Renderer->nodos) == 'p') {
//var_dump($instruction[1]);
//            $instruction[1][0] = str_replace("\n", "\\\\ \n", $instruction[1][0]);
//var_dump($instruction[1]);
//        }
